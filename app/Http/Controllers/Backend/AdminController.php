...
class AdminController extends Controller
{
    ...
    public function update_admin($id, Request $request)
    {
        ...
        return redirect('panel/admin')->with('success', "Admin successfully updated"); // Corrected redirect
    }
    ...
    public function delete_admin($id)
    {
        ...
        return redirect('panel/admin')->with('success', "Class successfully deleted");
    }
}