        ...
        <div class="login-container">
            ...
            <div class="login-box animated fadeInDown">
                <div class="login-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <a href="<?php echo e(url('forgot')); ?>" class="btn btn-link btn-block">Forgot your password?</a>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="login-footer">
                    <div class="pull-left">
                        &copy; <?php echo e(date('Y')); ?> Sekolah
                    </div>
...
<?php /**PATH C:\Users\User\project11\resources\views/auth/login.blade.php ENDPATH**/ ?>